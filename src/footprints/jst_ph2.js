...
//
// Author: @ceoloide
// Source: https://github.com/ceoloide/ergogen-footprints/blob/main/battery_connector_jst_ph_2.js
//
// Description:
...
module.exports = {
  ...
  body: (p) => {
    ...
    const standard_opening = `
          (module "ceoloide/battery_connector_jst_ph_2" (layer ${
            p.side
          }.Cu) (tedit 6135B927)
              ${p.at /* parametric position */}

              (descr "JST PH series connector, S2B-PH-K (http://www.jst-mfg.com/product/pdf/eng/ePH.pdf)")
              (fp_text reference "${p.ref}" (at 0 4.8 ${p.rot}) (layer "${
      p.side
    }.SilkS") ${p.ref_hide}
    ...
    const reversible_pads = `
              (pad 11 thru_hole oval (at -1 0 ${
                p.rot
              }) (size 1.2 1.75) (drill 0.75) (layers "*.Cu" "*.Mask") ${
      local_nets[0].str
    })
              (pad 12 thru_hole oval (at 1 0 ${
                p.rot
              }) (size 1.2 1.75) (drill 0.75) (layers "*.Cu" "*.Mask") ${
      local_nets[1].str
    })
              (pad 21 smd custom (at -1 1.8 ${
                180 + p.rot
              ...
              (pad 32 smd custom (at 1 1.8 ${
                180 + p.rot
                  ...
                  ${local_nets[1]})
              (pad 1 smd custom (at -1 2.816 ${
                180 + p.rot
              }) (size 1.2 0.5) (layers "F.Cu" "F.Mask") ${p.BAT_P.str}
                  (clearance 0.1) (zone_connect 0)
                  (options (clearance outline) (anchor rect))
                  (primitives
                  (gr_poly
              ...
              (pad 1 smd custom (at 1 2.816 ${
                180 + p.rot
              }) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.BAT_P.str}
                  (clearance 0.1) (zone_connect 0)
                  (options (clearance outline) (anchor rect))
                  (primitives
                  (gr_poly
              ...
              (pad 2 smd custom (at -1 2.816 ${
                180 + p.rot
              }) (size 1.2 0.5) (layers "B.Cu" "B.Mask") ${p.BAT_N.str}
                  (clearance 0.1) (zone_connect 0)
                  (options (clearance outline) (anchor rect))
                  (primitives
                  (gr_poly
              ...
              (pad 2 smd custom (at 1 2.816 ${
                180 + p.rot
              }) (size 1.2 0.5) (layers "F.Cu" "F.Mask") ${p.BAT_N.str}
                  (clearance 0.1) (zone_connect 0)
                  (options (clearance outline) (anchor rect))
                  (primitives
                  (gr_poly
    ...
    const reversible_traces = ` 
      (segment (start ${adjust_point(-1, 1.8)}) (end ${adjust_point(
      -1,
      0
    )}) (width ${p.trace_width}) (layer "F.Cu") (net ${local_nets[0].index}))
      (segment (start ${adjust_point(-1, 1.8)}) (end ${adjust_point(
      -1,
      0
    )}) (width ${p.trace_width}) (layer "B.Cu") (net ${local_nets[0].index}))
      (segment (start ${adjust_point(1, 1.8)}) (end ${adjust_point(
      1,
      0
    )}) (width ${p.trace_width}) (layer "F.Cu") (net ${local_nets[1].index}))
      (segment (start ${adjust_point(1, 1.8)}) (end ${adjust_point(
      1,
      0
    )}) (width ${p.trace_width}) (layer "B.Cu") (net ${local_nets[1].index}))
      `;
