// Author: Virginia224
// Source: https://github.com/Virginia2244/ergogen_footprints/blob/main/footprints/seeed_xaio.js
    ...
    left and right mean the left and right side of the microcontroller*/
      for (let i = 0; i < spacing.total_pin_num / 2; i++) {
        if (i < 3) {
          ...
          //Left VIAS
          solder_pads += `\t\t(pad ${i} thru_hole circle (at ${
            spacing.top_left_pin.x + spacing.pin_to_via
          } ${
            spacing.top_left_pin.y + i * spacing.pin_dist
          }) (size 0.8 0.8) (drill 0.4) (layers *.Cu *.Mask) ${
            pin_nets[i][0]
          })\n`;

          //Left Front male
          solder_pads += `\t\t(pad ${i} smd custom (at ${
            spacing.top_left_pin.x + spacing.pin_to_male_pad
          } ${spacing.top_left_pin.y + i * spacing.pin_dist} ${
            p.rot
          }) (size 0.2 0.2) (layers F.Cu F.Mask) ${p.local_net(i).str}`;
          ...
          solder_pads += `\t\t(pad ${
            ...
            spacing.top_left_pin.x + spacing.pin_to_female_pad
          } ${spacing.top_left_pin.y + i * spacing.pin_dist} ${
            p.rot
          }) (size 0.2 0.2) (layers F.Cu F.Mask) ${pin_nets[i][1]}`;
          ...
          solder_pads += `\t\t(pad ${i} smd custom (at ${
            ...
            p.rot
          }) (size 0.2 0.2) (layers B.Cu B.Mask) ${p.local_net(i).str}`;
          solder_pads += male_pad;
          ...
          solder_pads += `\t\t(pad ${i} smd custom (at ${
            ...
            p.rot
          }) (size 0.2 0.2) (layers B.Cu B.Mask) ${pin_nets[i][0]}`;
          solder_pads += female_pad;
          ...
          solder_pads += `\t\t(pad ${
            ...
            spacing.top_right_pin.x - spacing.pin_to_via
          } ${
            spacing.top_right_pin.y + i * spacing.pin_dist
          }) (size 0.8 0.8) (drill 0.4) (layers *.Cu *.Mask) ${
            pin_nets[i][1]
          ...
          solder_pads += `\t\t(pad ${
            ...
            spacing.top_right_pin.x - spacing.pin_to_male_pad
          } ${spacing.top_right_pin.y + i * spacing.pin_dist} ${
            180 + p.rot
          ...
          solder_pads += `\t\t(pad ${
            ...
            spacing.top_right_pin.x - spacing.pin_to_female_pad
          } ${spacing.top_right_pin.y + i * spacing.pin_dist} ${
            180 + p.rot
          }) (size 0.2 0.2) (layers B.Cu B.Mask) ${pin_nets[i][1]}`;
          solder_pads += female_pad;
          ...
          solder_pads += `\t\t(pad ${i} smd custom (at ${
            ...
            180 + p.rot
          }) (size 0.2 0.2) (layers F.Cu F.Mask) ${pin_nets[i][0]}`;
          solder_pads += female_pad;
    ...
    const get_traces = () => {
      ...
      for (let i = 0; i < spacing.total_pin_num / 2 && i < 3; i++) {
        ...
        traces += `\t(segment (start ${adjust_point(
          ...
          spacing.top_left_pin.x + trace_spacing.top_left.x,
          spacing.top_left_pin.y -
            trace_spacing.top_left.y +
            i * spacing.pin_dist
        )}) (width 0.25) (layer "F.Cu"))`;
        traces += `\t(segment (start ${adjust_point(
          spacing.top_left_pin.x + trace_spacing.top_left.x,
          ...
          spacing.top_right_pin.x - trace_spacing.top_right.x,
          spacing.top_right_pin.y -
            trace_spacing.top_right.y +
            i * spacing.pin_dist
        )}) (width 0.25) (layer "F.Cu"))`;
        traces += `\t(segment (start ${adjust_point(
          spacing.top_right_pin.x - trace_spacing.top_right.x,
        ...
        traces += `\t(segment (start ${adjust_point(
          ...
          spacing.top_right_pin.x - trace_spacing.bottom_right.x,
          spacing.top_right_pin.y +
            trace_spacing.bottom_right.y +
            i * spacing.pin_dist
        )})   (width 0.25) (layer "F.Cu"))`;
        traces += `\t(segment (start ${adjust_point(
          spacing.top_right_pin.x - trace_spacing.bottom_right.x,
          ...
          spacing.top_left_pin.x + trace_spacing.bottom_left.x,
          spacing.top_left_pin.y +
            trace_spacing.bottom_left.y +
            i * spacing.pin_dist
        )}) (width 0.25) (layer "F.Cu"))`;
        traces += `\t(segment (start ${adjust_point(
          spacing.top_left_pin.x + trace_spacing.bottom_left.x,
